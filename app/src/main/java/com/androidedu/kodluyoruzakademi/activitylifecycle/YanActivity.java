...
public class YanActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onUserLeaveHint() {  //  (DIK)  ||  (YAN)
        ...
        // Örneğin bir butona bastığımızda parmağımızı kaldırdığımızda önce onUserInteraction() metodu daha sonra da onUserLeaveHint() metodu tetiklenir.
    }
    ...
    @Override
    public void onAttachFragment(android.app.Fragment fragment) {  //  (DIK)  ||  (YAN)
    ...
    private void nesneleriTanimla() {
        ...
        txtAnaSayfa = (TextView) findViewById(R.id.txtAnaSayfa);

        imgView.setOnClickListener(this);
        txtAnaSayfa.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgView:
                ...
                break;
            case R.id.txtAnaSayfa:
                startActivity(new Intent(YanActivity.this, MainActivity.class));
                break;
            default:
                break;
        }
